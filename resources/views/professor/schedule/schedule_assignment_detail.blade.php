        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title"><i class="fas fa-calendar-check"></i> Schedule Assignment Details</h3>
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0">
                                        <span class="badge bg-primary me-2">Schedule Assignment</span>
                            ...
                            @if($schedule->source)
                                <div class="mt-3">
                                    <h6>Assignment Source:</h6>
                                    <p class="text-muted">
                                        <span class="badge bg-info">{{ $schedule->source === 'direct' ? 'Direct Assignment' : 'Subject Load Tracker' }}</span>
                                    </p>
                                </div>
                            @endif
                                ...
                                @foreach($otherSchedules->take(5) as $other)
                                    <div class="border-bottom pb-2 mb-2">
                                        <div class="d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="badge bg-{{ class_basename($other) === 'SubjectLoadTracker' ? 'success' : 'primary' }} small">
                                                {{ class_basename($other) === 'SubjectLoadTracker' ? 'SLT' : 'SA' }}
                                            </span>
                                        </div>
                                    </div>
                                @endforeach
